                        ...
                        <div class="divide-y divide-white/5">
                            @foreach($service->reasonPresets as $preset)
                                <div class="px-5 py-3 flex items-center gap-3 hover:bg-white/[0.02] transition-colors">
                                    ...
                                    <form action="{{ route('admin.reason-presets.update', $preset) }}" method="POST"
                                    ...
                                    <form action="{{ route('admin.reason-presets.destroy', $preset) }}" method="POST"
                                        onsubmit="return confirm('Remove this preset?')">
                                        @csrf @method('DELETE')
